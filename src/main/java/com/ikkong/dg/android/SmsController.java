...
public class SmsController extends BaseController {
	...
	/**
	 * 
	 * @param tempFlag 短信模板标记
	 * @param flag
	 */
	private void pushSms(int tempFlag, boolean flag) {
		...
		if(flag && userServ.hasValidPhone(phoneNo) == null) {
	...
	public void passdSms() {//找回密码短信
		pushSms(SmsTempCode.FIND_SMS.getTmpVal(), true);
	}
	
	public void registSms() {//注册短信
		pushSms(SmsTempCode.REGIST_SMS.getTmpVal(), false);
	}
}
