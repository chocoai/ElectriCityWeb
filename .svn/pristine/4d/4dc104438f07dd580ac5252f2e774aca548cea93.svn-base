...
import com.ikkong.core.sms.model.QuerySendDetailsRequest;
import com.ikkong.core.sms.model.QuerySendDetailsResponse;
import com.ikkong.core.sms.model.SendSmsRequest;
import com.ikkong.core.sms.model.SendSmsResponse;
import com.ikkong.core.sms.transform.SendSmsResponseUnmarshaller;
...
public class SmsDemo {
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("13510940534");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("奥博华");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode(REGISTER_PANEL);
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam("{\"code\":\"999888\"}");

        //选填-上行短信扩展码(无特殊需求用户请忽略此字段)
        //request.setSmsUpExtendCode("90997");

        //可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
        request.setOutId("电工系统1.0");
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("13530897682");
        //可选-流水号
