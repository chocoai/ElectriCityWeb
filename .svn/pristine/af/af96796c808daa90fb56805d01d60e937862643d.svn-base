...
import net.dreamlu.api.oauth.OauthDouban;
import net.dreamlu.api.oauth.OauthOsc;
import net.dreamlu.api.oauth.OauthQQ;
import net.dreamlu.api.oauth.OauthRenren;
import net.dreamlu.api.oauth.OauthSina;
import net.dreamlu.api.oauth.OauthWeixin;
...
public class Test {
	...
	public static void main(String[] args){
		StringBuffer idBuf = new StringBuffer("1,2,3,4,");
		String res = idBuf.deleteCharAt(idBuf.length()-1).toString();
		...
		StringBuffer sql = new StringBuffer("ab,cd,ef,gs,gh,");
...
//		System.out.println(qq.getUserInfoByCode("A6C773CE777D7A946A217E67E428E990"));
...
//		System.out.println(sina.getUserInfoByCode("d5767344a26f7a21cf34d73ba78f7885"));
...
//		System.out.println(baidu.getUserInfoByCode("1ab10163783660bbc3c373a95df87490"));
...
//        System.out.println(osc.getUserInfoByCode("uFSJWV"));
...
//      System.out.println(new OauthOsc().tweetPub(accessToken, "测试动弹，啦啦啦...").toString());
		...
		System.out.println(o.getAuthorizeUrl(TokenUtil.randomState()));
...
//		System.out.println(db.getUserInfoByCode("4ad0733f8c8601d9"));
		...
		System.out.println(ow.getAuthorizeUrl(TokenUtil.randomState()));
		
//		System.out.println(ow.getTokenByCode("031iCNu42S3E9L0U2Et42uzRu42iCNuU"));
//		System.out.println(ow.getUserInfo("uP7fTztUqSGYfvlmZ-wloyMWdUDKAWSd395L-1hCenFxmWbjxhbGKgnsoD9C4F1XPMWOeqdYur-jGAQmE7dkjb2Q2sTxNfFHPlc3-RCQCJQ", "oI_5Bv-nD-R4HpMLPlq_khNSUZVM"));
	}
}