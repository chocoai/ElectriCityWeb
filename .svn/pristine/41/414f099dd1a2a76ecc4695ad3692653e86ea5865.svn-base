...
public class JqGridFactory extends BaseGridFactory {
	...
	public JqGrid<Map<String, Object>> paginate(Integer page, Integer rows,
			String source, String para, String sort, String order,
			IQuery intercept, BaseController ctrl) {
		
		BladePage<Map<String, Object>> list = (BladePage<Map<String, Object>>) super.basePaginate(page, rows, source, para, sort, order, intercept, ctrl);
